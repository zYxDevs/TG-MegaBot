...
URL | filename | username | password"""
    ...
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Please Join Our Hentai Group 😌 @NekoPoiHNTch"
    AFTER_SUCCESSFUL_UPLOAD_MSG_WITH_TS = "Downloaded in {} seconds. \nPlease Join My Bots Channel @SpreadNetworks 😌."
    NOT_AUTH_USER_TEXT = "You Aren't An Approved User Please must Upgrade the plan /upgrade."
    NOT_AUTH_USER_TEXT_FILE_SIZE = "Detected File Size: {}. Free Users can only upload: {}\nPlease /upgrade your subscription.\nIf you think this is a bug, please contact <a href='https://telegram.dog/YBotsSupport'>Support Group</a>"
    ...
    NO_VOID_FORMAT_FOUND = "something is wrong with the URL you gave me 🤦‍♀️. If you think this could be a bug please report on https://t.me/OwnerCH_Bot OR @Yoga_CIC\n<b>YouTubeDL</b> said: {}"
...
<b>👉 Create own Clone Bot :</b> 👉 <a href="https://nothing.com">Deploy</a>
--------
Send /me to know current plan details"""
    REPLY_TO_DOC_GET_LINK = "Reply to a Telegram media to get High Speed Direct Download Link 😌"
    REPLY_TO_DOC_FOR_C2V = "Reply to a Telegram media to convert 😌"
    REPLY_TO_DOC_FOR_SCSS = "Reply to a Telegram media to get screenshots 🤦‍♀️"
    REPLY_TO_DOC_FOR_RENAME_FILE = "Reply to a Telegram media to /rename with custom thumbnail support 🤦‍♀️"
    AFTER_GET_DL_LINK = "Direct Link <a href='{}'>Generated</a> valid for {} days.\nPowered By @SpreadNetworks"
    ...
    USER_DELETED_FROM_DB = "User <a href='tg://user?id={}'>{}</a> deleted from DataBase 🤷‍♀️."
    ...
    FF_MPEG_RO_BOT_AD_VER_TISE_MENT = "https://telegram.dog/SpreadNetworks"
    EXTRACT_ZIP_INTRO_ONE = "Send a compressed file first, Then reply /unzip command to the file."
    EXTRACT_ZIP_INTRO_THREE = "Analyzing received file. ⚠️ This might take some time. Please be patient. "
    UNZIP_SUPPORTED_EXTENSIONS = ("zip", "rar")
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/YBotsSupport'>Support Group</a>"
    EXTRACT_ZIP_STEP_TWO = """Select file_name to upload from the below options 😌.
You can use /rename command after receiving file to rename it with custom thumbnail support."""
    GET_LINK_ERRS_OCCURED = "Sorry the following Errors occurred: \n{}\nPlease check everything again twice, and if the issue persists, report this to <a href='https://telegram.dog/YBotsSupport'>Support Group</a>"
...
/upgrade or Try 1800 seconds later."""
    ...
    FED_UP_WITH_CRAP = "This bot is no longer leeching links for free users. @xUploadUrlBot is open source, and you can deploy your own telegram upload by clicking on the links, available in <a href='https://nothing.com>GitHub README</a>. or, Better /upgrade the subscription to continue using this bot."
